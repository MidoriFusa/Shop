namespace Shop.Identity
{
    ...
    public interface IIdentityStorage
    {
        ...
        /// The <see cref="SystemUser"/>.
        /// </returns>
        SystemUser GetUser(string email, string password);
        ...
        /// </returns>
        ClaimsIdentity CreateIdentity(SystemUser user, string type);
        ...
        /// </returns>
        IdentityResult CreateUser(SystemUser user, string password, params string[] roles);
        ...
        /// The <see cref="IdentityResult"/>.
        /// </returns>
        IdentityResult Update(SystemUser user);
        ...
        /// The <see cref="IdentityResult"/>.
        /// </returns>
        IdentityResult UpdateReLoginRequired(SystemUser user);
        ...
        /// The <see cref="SystemUser"/>.
        /// </returns>
        SystemUser GetUser(UserLoginInfo userLoginInfo);
