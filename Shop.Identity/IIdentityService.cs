namespace Shop.Identity
{
    ...
    public interface IIdentityService
    {
        ...
        /// </returns>
        Task<ServiceResult<bool>> ChangePasswordAsync(SystemUser user, string newPassword);
        ...
        /// The <see cref="ServiceResult{T}"/>.
        /// </returns>
        ServiceResult<string> Register(SystemUser user, string password, params string[] roles);
        ...
        /// The <see cref="ServiceResult{T}"/>.
        /// </returns>
        ServiceResult<SystemUser> GetUserProfile(string id);
        ...
        /// The <see cref="ServiceResult{T}"/>.
        /// </returns>
        ServiceResult<SystemUser> GetUserProfile(UserLoginInfo userLoginInfo);
        ...
        /// The <see cref="ServiceResult{T}"/>.
        /// </returns>
        ServiceResult<SystemUser> GetUserProfile(string email, string password);
        ...
        /// The <see cref="ServiceResult{T}"/>.
        /// </returns>
        ServiceResult<ClaimsIdentity> CreateIdentity(SystemUser user, string applicationCookie);
        ...
        /// The <see cref="ServiceResult{T}"/>.
        /// </returns>
        ServiceResult<bool> UpdateUser(SystemUser user);
        ...
        /// .
        /// </returns>
        ServiceResult<bool> UpdateReLoginRequired(SystemUser user);
        ...
        /// The <see cref="ServiceResult{T}"/>.
        /// </returns>
        ServiceResult<IdentityRoles> GetRoles();
        ...
        /// The <see cref="ServiceResult"/>.
        /// </returns>
        ServiceResult<IdentityRoles> GetUserRoles(string userId);
